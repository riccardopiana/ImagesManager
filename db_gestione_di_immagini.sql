...
CREATE TABLE `Comment` (
  ...
  PRIMARY KEY (`ID`),
  KEY `utente_idx` (`User`),
  KEY `immagine_idx` (`Image`),
  CONSTRAINT `image` FOREIGN KEY (`Image`) REFERENCES `Image` (`Path`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `ImageOfAlbum` (
  ...
  CONSTRAINT `album` FOREIGN KEY (`Album`) REFERENCES `Album` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ImageOfAlbum_1` FOREIGN KEY (`Image`) REFERENCES `Image` (`Path`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-07 17:15:18
